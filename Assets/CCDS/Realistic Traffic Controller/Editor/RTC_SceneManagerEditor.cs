...
public class RTC_SceneManagerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (FindFirstObjectByType<RTC_TrafficSpawner>() == null)
    ...
    private void GetEverything() {
        ...
        prop.allLanes = FindObjectsByType<RTC_Lane>(FindObjectsInactive.Include, FindObjectsSortMode.None);
        prop.allWaypoints = FindObjectsByType<RTC_Waypoint>(FindObjectsInactive.Include, FindObjectsSortMode.None);
