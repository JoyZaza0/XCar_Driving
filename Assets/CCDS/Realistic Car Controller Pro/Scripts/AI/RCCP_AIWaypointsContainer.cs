...
public class RCCP_AIWaypointsContainer : RCCP_GenericComponent {
	...
	private void OnDrawGizmos() 
	{
		...
		//if (HasDuplicates(transforms))
		//{
		//	Debug.LogError("Has duplicates " + gameObject.name);
		//}
		//else
		//{
		//	Debug.Log("not duplicates" + gameObject.name);
		//}
	...
	private bool HasDuplicates(List<Transform> list)
	{
