...
Shader "RCCP Car Body Shader URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV305 = dot( WorldNormal, WorldViewDirection );
				float fresnelNode305 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV305 , 0.0001 ), 1.5 ) );
				float3 ase_reflectionWS = reflect( -WorldViewDirection, WorldNormal );
				float2 temp_cast_1 = (1.0).xx;
				float mulTime292 = _TimeParameters.x * _CloudsSpeed;
				float cos276 = cos( mulTime292 );
				float sin276 = sin( mulTime292 );
				float2 rotator276 = mul( ase_reflectionWS.xy - temp_cast_1 , float2x2( cos276 , -sin276 , sin276 , cos276 )) + temp_cast_1;
				float2 uv_MainTex = input.ase_texcoord9.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float fresnelNdotV223 = dot( WorldNormal, WorldViewDirection );
				float fresnelNode223 = ( 0.1 + 1.0 * pow( max( 1.0 - fresnelNdotV223 , 0.0001 ), _FresnelPower ) );
				...
				float3 unpack242 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalMapIntensity );
				unpack242.z = lerp( 1, unpack242.z, saturate(_NormalMapIntensity) );
				
				float2 uv_Flakes = input.ase_texcoord9.xy * _Flakes_ST.xy + _Flakes_ST.zw;
				float clampResult228 = clamp( ( 1.0 - _FlakesRimPower ) , 0.0 , 1.0 );
				float fresnelNdotV392 = dot( WorldNormal, _MainLightPosition.xyz );
				float fresnelNode392 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV392 , 0.0001 ), clampResult228 ) );
				float clampResult229 = clamp( ( 1.0 - fresnelNode392 ) , 0.0 , 1.0 );
				float4 saferPower86 = abs( ( ( _FlakesIntensity * tex2D( _Flakes, uv_Flakes ) ) * clampResult229 ) );
				float4 temp_cast_3 = (_FlakesPower).xxxx;
				float4 temp_output_86_0 = pow( saferPower86 , temp_cast_3 );
				
				float2 uv_Specular = input.ase_texcoord9.xy * _Specular_ST.xy + _Specular_ST.zw;
				

				float3 BaseColor = ( pow( ( pow( fresnelNode305 , 1.0 ) * ( tex2D( _CloudsReflection, ( _CloudsTiling * rotator276 ) ).a * _CloudsIntensity ) ) , 0.5 ) + lerpResult221 ).rgb;
				float3 Normal = unpack242;
				float3 Emission = temp_output_86_0.rgb;
				float3 Specular = 0.5;
				float Metallic = _MetallicIntensity;
				float Smoothness = ( temp_output_86_0 + ( _SmoothnessIntensity * tex2D( _Specular, uv_Specular ) ) ).r;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNdotV305 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode305 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV305 , 0.0001 ), 1.5 ) );
				float3 ase_reflectionWS = reflect( -ase_viewDirWS, ase_normalWS );
				float2 temp_cast_1 = (1.0).xx;
				float mulTime292 = _TimeParameters.x * _CloudsSpeed;
				float cos276 = cos( mulTime292 );
				float sin276 = sin( mulTime292 );
				...
				float fresnelNdotV223 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode223 = ( 0.1 + 1.0 * pow( max( 1.0 - fresnelNdotV223 , 0.0001 ), _FresnelPower ) );
				float4 lerpResult221 = lerp( _FresnelColor , ( _DiffuseColor * tex2D( _MainTex, uv_MainTex ) ) , fresnelNode223);
				
				float2 uv_Flakes = input.ase_texcoord5.xy * _Flakes_ST.xy + _Flakes_ST.zw;
				float clampResult228 = clamp( ( 1.0 - _FlakesRimPower ) , 0.0 , 1.0 );
				float fresnelNdotV392 = dot( ase_normalWS, _MainLightPosition.xyz );
				float fresnelNode392 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV392 , 0.0001 ), clampResult228 ) );
				float clampResult229 = clamp( ( 1.0 - fresnelNode392 ) , 0.0 , 1.0 );
				float4 saferPower86 = abs( ( ( _FlakesIntensity * tex2D( _Flakes, uv_Flakes ) ) * clampResult229 ) );
				float4 temp_cast_3 = (_FlakesPower).xxxx;
...
Node;AmplifyShaderEditor.SamplerNode;359;-464.5139,-693.3469;Inherit;True;Property;_Specular;Specular;16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;242;586.2443,-1421.812;Inherit;True;Property;_NormalMap;Normal Map;4;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;58;-855.0099,-2489.855;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;38;-924.879,-2317.658;Inherit;True;Property;_MainTex;Diffuse Texture;0;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;220;-857.2408,-2661.021;Inherit;False;Property;_FresnelColor;Fresnel Color;10;0;Create;True;0;0;0;False;0;False;1,0,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;259;-103.7089,-3421.104;Inherit;True;Property;_CloudsReflection;Clouds Reflection;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;189;-1276.84,-1360.867;Inherit;True;Property;_Flakes;Flakes;6;0;Create;True;0;0;0;False;0;False;-1;None;acc2168de4ee88749a498cfd3c6a5f07;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleAddOpNode;370;-195.7749,-1193.73;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;393;-1707.536,-1202.463;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.PowerNode;86;-534.0361,-1428.468;Inherit;True;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;392;-1396.066,-1009.516;Inherit;True;Standard;WorldNormal;LightDir;False;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;223;-794.012,-2130.765;Inherit;True;Standard;WorldNormal;ViewDir;False;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
WireConnection;392;3;228;0
WireConnection;223;1;225;0
WireConnection;223;3;224;0
WireConnection;305;3;300;0
WireConnection;383;0;296;0
WireConnection;383;1;242;0
WireConnection;383;2;86;0
WireConnection;383;3;183;0
WireConnection;383;4;370;0
ASEEND*/
//CHKSM=2A1D5ADA959CBD73A620E290B4A8E270E471D034