...
public class RCCP_VehicleUpgrade_Handling : RCCP_Component {
    ...
    public void Initialize() {
        ...
        if (defHandling <= 0)
            defHandling = CarController.Stability.steerHelperStrength;

        CarController.Stability.steerHelperStrength = Mathf.Lerp(defHandling, defHandling * efficiency, HandlingLevel / 5f);
    ...
    public void Restore() {
        ...
        CarController.Stability.steerHelperStrength = defHandling;
